...
- an exact version such as `3.13.0`;
- a minor version such as `3.13`;
- a version range such as `>=3.10,<3.14`;
- a direct interpreter path such as `/opt/homebrew/bin/python3.13`.
