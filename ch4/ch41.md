...
% We execute everything outside the book project directory to ensure that uv works in a fully clean workspace
```{code-cell} bash
:tags: ["remove-input"]
mkdir -p ../../home/ch41
cd ../../home/ch41
...
This command creates a new `my-project` directory with the following files and directories:
