...
This pins the interpreter version for the project. In practice, it helps keep all contributors on the same Python major/minor version.
...
This is the project's metadata and dependency manifest.
