...
Go ahead and press `Ctrl+I`. You will see a chat window open. Prompt :
...
- Asking for expert opinion in some field. Start your prompts like "As a expert software developer ..."


## Integration in other parts of the development process
Github copilot can also support other parts of the software development process and every day is adding new ones, to the date it has the following features availables:
