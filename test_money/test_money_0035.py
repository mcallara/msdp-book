...
# Next step: Refactor: Create factory method dollar
# If we want to eliminate the two classes Dollar and Franc, we first need
# to remove the direct references in the test. We can do this by creating
# factory methods in Money that creates Dollars and Francs as needed.
